  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">States</h1>
          <p className="text-sm text-slate-500 mt-1">Manage operational states or regions.</p>
        </div>
      </div>
                  ...
                  {states.length === 0 ? (
                    <tr>
                      <td colSpan={3} className="px-6 py-12 text-center text-slate-500">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-base font-medium text-slate-600">No states found</p>
                    ...
                    states.map((state) => (
                      <tr key={state.id} className="hover:bg-slate-50 transition-colors group">
                        <td className="px-6 py-3 font-bold text-slate-900">{state.name}</td>
