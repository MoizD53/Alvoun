  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="flex gap-4 border-b border-slate-200 dark:border-slate-800 pb-2">
        ...
        <a href="/dashboard/admin/cities" className="px-4 py-2 text-sm font-medium border-b-2 border-transparent text-slate-500 hover:text-slate-700 dark:hover:text-slate-300">
          Cities
        </a>
        <a href="/dashboard/admin/states" className="px-4 py-2 text-sm font-medium border-b-2 border-alvoun-blue text-alvoun-blue">
          States
        </a>
      </div>
